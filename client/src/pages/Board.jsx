...
import { deleteBoardAsync, setBoard, setBoards, setFavouriteList} from '../redux/features/boardSlice'
...
const Board = () => {
  ...
  const {boards, favouriteList} = useSelector((state) => state.board)
  ...
  return (
    <>
      <Box sx={{
        ...
        <IconButton variant='outlined' color='error' onClick={() => dispatch(deleteBoardAsync(boardId))}>
          <DeleteOutlinedIcon />
        </IconButton>
      </Box>
